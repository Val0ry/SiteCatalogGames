...
<section>
	<div class="container mx-auto">
		<div class="grid-cols-3 p-20 space-y-2 lg:space-y-0 lg:grid lg:gap-3 lg:grid-rows-3">
			<div class="w-full">
				<a data-modal-target="defaultModal" data-modal-toggle="defaultModal" data-image-source="<?= $image2 ?>"><img class="rounded-lg" src="<?= $image2 ?>" alt="image"></a>
			</div>
			<div class="w-full col-span-2 row-span-2">
				<a data-modal-target="defaultModal" data-modal-toggle="defaultModal" data-image-source="<?= $image6 ?>"><img class="rounded-lg" src="<?= $image6 ?>" alt="image"></a>
			</div>
			<div class="w-full">
				<a data-modal-target="defaultModal" data-modal-toggle="defaultModal" data-image-source="<?= $image3 ?>"><img class="rounded-lg" src="<?= $image3 ?>" alt="image"></a>
			</div>
			<div class="w-full">
				<a data-modal-target="defaultModal" data-modal-toggle="defaultModal" data-image-source="<?= $image4 ?>"><img class="rounded-lg" src="<?= $image4 ?>" alt="image"></a>
			</div>
			<div class="w-full">
				<a data-modal-target="defaultModal" data-modal-toggle="defaultModal" data-image-source="<?= $image5 ?>"><img class="rounded-lg" src="<?= $image5 ?>" alt="image"></a>
			</div>
			<div class="w-full">
				<a data-modal-target="defaultModal" data-modal-toggle="defaultModal" data-image-source="<?= $image ?>"><img class="rounded-lg" src="<?= $image ?>" alt="image"></a>
			</div>
		</div>
		<div class="">
			<a data-modal-target="defaultModal" data-modal-toggle="defaultModal" data-image-source="<?= $videos ?>">
				<video class="flex justify-center player rounded-lg" autoplay muted controls>
			...
			<div id="defaultModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
				<div class="slider">
					<div id="default-carousel" class="relative w-full" data-carousel="static">
						<div class="relative hmodal overflow-hidden rounded-lg">
							<div class="hidden duration-700 ease-in-out" data-carousel-item>
								<img src="<?= $image2 ?>" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
							</div>
							<div class="hidden duration-700 ease-in-out" data-carousel-item>
								<img src="<?= $image6 ?>" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
							</div>
